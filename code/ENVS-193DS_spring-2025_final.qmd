...
The visualizations differ because in Homework 2, I simply categorized the workouts as either cardiovascular or strength training, providing a broad overview. In Homework 3, I refined the focus by analyzing how specific muscle groups targeted during workouts correlated with water consumption, offering a more nuanced and affective perspective on how exercise intensity influences hydration. This shift in perspective allowed me to move from a general to a more detailed and insightful understanding of the data.
...
Even though there were not a lot of observations in Homework 2, I still noticed clear differences in average water consumption between cardiovascular and strength workouts, reflecting the higher hydration demands of more intensive strength training sessions. In Homework 3, the patterns became more detailed, revealing varying relationships between specific muscle groups engaged and water consumption, showing, for example, that workouts targeting larger muscle groups prompted greater hydration and intensity. While both visualizations highlight differences in water consumption, the most current visuals offer a more focused lens that uncovers subtler patterns that were not visible in the initial exploratory process. 
